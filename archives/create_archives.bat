...
set higurashiData=HigurashiEp02_Data
...
set assetsMacOsLinux=LinuxMac-Steam-MG-GOG-5.2.2f1.languagespecificassets

set output07th=watanagashi_ita_07th_mod_installer.7z
set outputWindows=watanagashi_ita_windows_XXX.7z
set outputMacOsLinux=watanagashi_ita_macos_linux_XXX.7z
